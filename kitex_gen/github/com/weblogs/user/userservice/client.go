...
type Client interface {
	...
	SignIn(ctx context.Context, req *user.SignInRequest, callOptions ...callopt.Option) (r *user.SignInResponse, err error)
	SignOut(ctx context.Context, req *user.SignOutRequest, callOptions ...callopt.Option) (r *user.SignOutResponse, err error)
}
...
func (p *kUserServiceClient) SignIn(ctx context.Context, req *user.SignInRequest, callOptions ...callopt.Option) (r *user.SignInResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.SignIn(ctx, req)
}

func (p *kUserServiceClient) SignOut(ctx context.Context, req *user.SignOutRequest, callOptions ...callopt.Option) (r *user.SignOutResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.SignOut(ctx, req)
}
